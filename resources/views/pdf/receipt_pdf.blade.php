  	...
  	<body>
  		...
  		<div>
              ...
              <tr>
                  ...
                  <td>PHP {{number_format($receipt->invoiceInfo->total_amount-(number_format($receipt->invoiceInfo->total_amount*.12,2)),2)}}</td>
              </tr>
              <tr>
                  <td style="background: #eee" colspan="2" align="right" style="padding-right:5px;"> VAT(12%): </td>
                  <td>PHP {{number_format($receipt->invoiceInfo->total_amount*.12,2)}}</td>
              </tr> 
          		<tr>
              		<td style="background: #eee" colspan="2" align="right" style="padding-right:5px;"> Total Amount: </td>
              		<td>PHP {{$receipt->invoiceInfo->total_amount}}</td>
          		</tr>
              <tr>
